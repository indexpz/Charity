...
//                .antMatchers("/users/user-editpasswordform.jsp").fullyAuthenticated()
                ...
                .antMatchers("/webapp/resources/css", "/webapp/resources/css/**").permitAll()
                .antMatchers("/webapp/resources/images", "/webapp/resources/images/**").permitAll()
                .antMatchers("/webapp/resources/js", "/webapp/resources/js/**").permitAll()
