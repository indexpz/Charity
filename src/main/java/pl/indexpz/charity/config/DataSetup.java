...
public class DataSetup {
    ...
    public void setUpData() {
        ...
        createDonationIfNotExist(1L,  1, "Pierwsza", null, null, null,null, null, null);
        createDonationIfNotExist(2L,  2, "Druga", null, null, null, null, null, null);
        createDonationIfNotExist(3L,  3, "Trzecia", null, null, null,null, null, null);
    ...
    private void createDonationIfNotExist(Long id,  Integer quantity, String street, String city, String zipCode, String phone, LocalDate pickUpDate, LocalTime pickUpTime, String pickUpComment) {
        if(donationServiceInterface.getDonationById(id).isPresent()){
            ...
            Donation donation = new Donation(null,  quantity, street, city, zipCode, phone, pickUpDate, pickUpTime, pickUpComment, null, null);
